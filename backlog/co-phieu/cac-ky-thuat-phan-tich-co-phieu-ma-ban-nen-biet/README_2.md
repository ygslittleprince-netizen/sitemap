...
notes: >
  ...
  xác nhận URL trước khi publish. Trình bày HTML (index.html) đã được làm
  lại theo đúng CSS/layout của bài "Cổ phiếu là gì? Vì sao nên đầu tư cổ
  phiếu?" (backlog/co-phieu/co-phieu-la-gi-vi-sao-nen-dau-tu-co-phieu) theo
  yêu cầu người duyệt, để đồng bộ giao diện toàn hub. Đã rà soát và bỏ hết
  dấu gạch ngang dùng làm liên từ trong câu, theo quy tắc văn phong của
  skill tcbs-content-writer.
---
...
### 1. P/E: Hệ số giá trên lợi nhuận
...
### 2. P/B: Hệ số giá trên giá trị sổ sách
...
- **Chất lượng báo cáo tài chính:** dòng tiền kinh doanh có đi cùng lợi nhuận kế toán hay không, tỷ lệ nợ vay, khả năng thanh toán qua nhiều năm.
- **Năng lực ban lãnh đạo:** uy tín và lịch sử thực hiện cam kết với cổ đông.
- **Vị thế cạnh tranh trong ngành:** thị phần hiện có và rào cản gia nhập ngành đối với đối thủ mới.
- **Bối cảnh vĩ mô và chu kỳ ngành:** lãi suất, tỷ giá, chính sách quản lý ngành đang tác động thế nào đến triển vọng kinh doanh.
...
- Nhầm lẫn giữa cổ phiếu tốt, tức doanh nghiệp tốt, và thời điểm mua tốt, tức giá hợp lý. Đây là hai câu hỏi khác nhau, cần hai công cụ khác nhau để trả lời.
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Phân tích cơ bản đánh giá giá trị thực của doanh nghiệp qua báo cáo tài chính và yếu tố vĩ mô để trả lời câu hỏi nên mua cổ phiếu nào. Phân tích kỹ thuật dựa vào biểu đồ giá và khối lượng giao dịch lịch sử để trả lời câu hỏi nên mua hoặc bán vào lúc nào."
      }
    },
    {
      "@type": "Question",
